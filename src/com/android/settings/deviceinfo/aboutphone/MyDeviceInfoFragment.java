...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    protected int getPreferenceScreenResId() {
        return R.xml.fortune_about_phone;
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        try {
            ...
            if (brandedAccount.isVisible() || emergencyPref.isVisible() ) {
                deviceName.setLayoutResource(R.layout.fortune_pref_card_top);
            } else {
                deviceName.setLayoutResource(R.layout.fortune_pref_card_sin);
            }
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
        ...
        controllers.add(new FortuneInfoPreferenceController(context));
        return controllers;
    }
    ...
    public static final BaseSearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
            new BaseSearchIndexProvider(R.xml.fortune_about_phone) {
