...
public class AppInfoDashboardFragment extends DashboardFragment
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (com.android.internal.util.fortune.FortuneUtils.isPackageInstalled(mContext,"com.android.vending")) {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (com.android.internal.util.fortune.FortuneUtils.isPackageInstalled(getContext(),"com.android.vending")) {
